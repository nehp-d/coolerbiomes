...
public class ViciataItem extends CoolerBiomesModElements.ModElement {
	@ObjectHolder("cooler_biomes:viciata")
	public static final Item block = null;
	public ViciataItem(CoolerBiomesModElements instance) {
		super(instance, 1);
	}
